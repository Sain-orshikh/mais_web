...
const generateCountryData = (): CountryData[] => {
  ...
  const regionColorAssignment: { [key: string]: string } = {
    ...
    "KR": distinctColors[13], // Dark Purple
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 min-h-[500px]">
          ...
          <div className="lg:col-span-1 flex flex-col space-y-6 h-full">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm flex-1">
              <h3 className="text-lg font-semibold text-gray-800 mb-3 text-center">Alumni Statistics</h3>              <div className="grid grid-cols-2 gap-2 h-full">
                <div className="text-center p-2 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg flex flex-col justify-center">
                  <p className="text-2xl font-bold text-blue-600">{filteredCountryData.reduce((sum, country) => sum + country.value, 0)}</p>
                ...
                <div className="text-center p-2 bg-gradient-to-br from-green-50 to-green-100 rounded-lg flex flex-col justify-center">
                  <p className="text-2xl font-bold text-green-600">{filteredCountryData.length}</p>
                ...
                <div className="text-center p-2 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg flex flex-col justify-center">
                  <p className="text-2xl font-bold text-purple-600">{filteredCountryData.reduce((sum, country) => sum + getUniversitiesByCountry(country.country).length, 0)}</p>
                ...
                <div className="text-center p-2 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg flex flex-col justify-center">
                  <p className="text-2xl font-bold text-orange-600">{searchTerm ? filteredCountryData.length : countryData.length}</p>
