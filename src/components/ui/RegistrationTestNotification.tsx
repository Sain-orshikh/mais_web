...
const RegistrationTestNotification = () => {
  ...
  const registrationEvent = {
    title: t?.registrationTestNotification.title || "Admissions Test Registration",
    description: t?.registrationTestNotification.description || "Registration opens for the MAIS entrance examination. Limited spots available!",
  ...
  const getStatusInfo = () => {
    if (countdown.days === 0 && countdown.hours === 0) {
      return {
        status: t.registrationTestNotification.status.last_chance,
        urgency: t.registrationTestNotification.urgency.last_chance
      };
    } else if (countdown.days === 0) {
      return {
        status: t.registrationTestNotification.status.closing_soon,
        urgency: t.registrationTestNotification.urgency.closing_soon
      };
      ...
      return {
        status: t.registrationTestNotification.status.open,
        urgency: t.registrationTestNotification.urgency.open
      };
    }
  };
              ...
              >                {isCollapsed ? (
                  ...
                  <>                    {/* Header */}
                    ...
                    <div className="bg-white shadow border rounded-md p-3 mb-3">
                      ...
                      </div>                      <div className="flex items-center text-gray-600 text-xs mb-1">
                        <svg className="h-3 w-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span>{t.registrationTestNotification.dateRange}</span>
                    ...
                    {/* CTA Button */}                    <motion.button 
                      ...
                      whileTap={{ scale: 0.98 }}
                    >
                      <span>{t.registrationTestNotification.registerNow}</span>
